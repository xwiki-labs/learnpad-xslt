...
@Component
@Named("eu.learnpad.DefaultXWikiImporter")
public class DefaultXWikiImporter implements XWikiImporter, XWikiRestComponent {
	@Inject
	...
	public void importWiki(String path) throws XWikiRestException {
