...
___________________________________________________________________________________________________-->
	<xsl:template match="MODEL" mode="BPMN">
		<xsl:result-document method="xml" href="xwiki/{@id}/WebHome/index.xml">
		...
		<xsl:result-document method="xml"
			href="xwiki/{@id}/WebHome/objects/{$learnpadCodeSpace}/{$modelClassName}/0.xml">
...
<!--...............................................................................................-->
	...
	<xsl:template match="CONNECTOR">
		...
		<xsl:result-document method="xml"
			href="xwiki/{$modelId}/{$fromId}/objects/{$learnpadCodeSpace}/{$linkClassName}/{@id}.xml">
			<object xmlns="http://www.xwiki.org">
		...
		<xsl:result-document method="xml"
			href="xwiki/{$modelId}/{$toId}/objects/{$learnpadCodeSpace}/{$linkClassName}/{@id}.xml">
			<object xmlns="http://www.xwiki.org">
				<className><xsl:copy-of select="$linkClass" /></className>
				<property name="id" type="String">
					<value><xsl:value-of select="@id" /></value>
...
___________________________________________________________________________________________________-->
	<xsl:template match="INSTANCE" mode="StartEvent">
		...
		<xsl:result-document method="xml"
			href="xwiki/{$bpId}/{@id}/objects/{$learnpadCodeSpace}/{$flowNodeClassName}/{@id}.xml">
			<object xmlns="http://www.xwiki.org">
		...
		<xsl:result-document method="xml"
			href="xwiki/{$bpId}/{@id}/objects/XWiki/DocumentSheetBinding/bind.xml">
			<object xmlns="http://www.xwiki.org">
